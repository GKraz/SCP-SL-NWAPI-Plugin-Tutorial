...
namespace SCPSL_Plugin_Training._2._Example
{
    public class BasicExample
    {
        ...
        /// </summary>
        [PluginEntryPoint(pluginName: "ExampleBasic", pluginVersion: "0.0.0", description: "A basic plugin example", author: "DMFGames")]
        public void EntryPoint()
        {
            ...
            Log.Info(message: "ExampleBasic loaded successfully!");
        }
    ...
    {
        [PluginEntryPoint("ExampleBasic", "0.0.0", "A basic plugin example", "DMFGames")]
        public void EntryPoint()
        {
            EventManager.RegisterEvents<BasicExampleNoComments>(this);
            
            Log.Info("ExampleBasic loaded successfully!");
        }
